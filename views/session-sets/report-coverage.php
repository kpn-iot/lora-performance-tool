...
DetailView::widget([
    ...
    'attributes' => [
        ...
        'sessionCollection.frameCollection.nrFrames:integer'
    ],
])
?>
...
<?php else: ?>
    <i>For large session sets (more than <?= $sessionCollection->frameCollection::$largeThreshold ?> frames) the table cannot be
        shown</i>
<?php endif ?>
