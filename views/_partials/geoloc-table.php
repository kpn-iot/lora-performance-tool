    ...
    <table class="table table-condensed table-bordered">
        ...
        <tr>
          ...
          <?php endif ?>
            ...
            <th colspan="2" class="text-center">GeoLoc</th>
            <th colspan="4" class="text-center">GeoLoc Info</th>
        ...
        <tr>
          ...
          <?php endif ?>
            ...
            <th class="text-right">Accuracy [m]</th>
        ...
        <?php foreach ($frames as $index => $frame): ?>
          <?php if ($nrDevices == 1 && $index > 0 && ($frame['count_up'] != $frames[$index - 1]['count_up'] + 1)): ?>
            ...
            <?php endfor ?>
          <?php endif ?>
            <tr <?php if ($frame['location_age_lora'] !== null && $frame['location_age_lora'] < Frame::$locationAgeThreshold): ?>class="info"<?php endif ?>>
              <?php if ($withDeviceEui): ?>
                  <td><?= $frame['device_eui'] ?></td>
              <?php endif ?>
                ...
                <td class="text-right"><?= ($frame['location_age_lora'] !== null && $frame['location_age_lora'] < Frame::$locationAgeThreshold) ? Yii::$app->formatter->asDecimal($frame['distance'], 1) : '' ?></td>
                <td class="text-right">
                    <b><?= ($frame['location_age_lora'] !== null && $frame['location_age_lora'] < Frame::$locationAgeThreshold && isset($frame['bearingArrow'])) ? $frame['bearingArrow'] : null ?></b>
                </td>
