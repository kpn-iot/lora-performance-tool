...
<p class="hidden-print">
  A <span class="bg-info">blue line</span> indicates that for that frame a new GeoLoc result is received from the LocSolver. A <span class="bg-danger">red line</span> indicates that frame is not received.
</p>
  ...
  <table class="table table-condensed table-bordered">
    <thead>
      <tr>
        ...
        <th colspan="2" class="text-center">GeoLoc Info</th>
