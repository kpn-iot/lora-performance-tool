...
/** @var $medianAccuracyGraphData array */
/** @var $averageAccuracyGraphData array */
/** @var $successRateGraphData array */
/** @var $gwCountGraphData array */
/** @var $snrGraphData array */

$this->title = $model->name;
$this->params['breadcrumbs'][] = ['label' => 'Device Groups', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Graphs';
...
<?php if ($nrResults > 0): ?>
    <div class="container-fluid">
        ...
        <div id="avg-accuracy-graph"></div>
        <div id="success-graph"></div>
        <div id="gw-count-graph"></div>
        <div id="snr-graph"></div>
        ...
        <script>
            ...
            function drawThis() {
                ...
                lineGraph('accuracy-graph', {
                    ...
                    height: 300,
                    data: <?= json_encode($medianAccuracyGraphData) ?>,
                    yAxisTitle: 'Accuracy [m]'
                });
                lineGraph('avg-accuracy-graph', {
                    title: 'LocSolve average accuracy over time',
                    height: 300,
                    data: <?= json_encode($averageAccuracyGraphData) ?>,
                    yAxisTitle: 'Accuracy [m]'
                });
                ...
                lineGraph('2d-graph', {
                    title: 'Nr receiving gateways over time',
                    height: 300,
                    data: <?= json_encode($gwCountGraphData) ?>,
                    yAxisTitle: 'Nr Gateways'
                });
                lineGraph('snr-graph', {
                    title: 'Average SNR over time',
                    height: 300,
                    data: <?= json_encode($snrGraphData) ?>,
                    yAxisTitle: 'SNR [dB]'
                });
            }
